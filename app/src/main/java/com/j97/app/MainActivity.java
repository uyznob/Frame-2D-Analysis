...
import com.j97.app.ui.output.GraphPoint;
import com.j97.app.ui.output.OutputFragment;
import com.j97.app.ui.output.Point;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<GraphPoint> fakeData() {
        List<GraphPoint> result = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            GraphPoint graphPoint = new GraphPoint(new Point(Math.random() * 200 - 100, Math.random() * 200 - 100),
